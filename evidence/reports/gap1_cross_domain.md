...
Generated 2026-09-09T20:05:30+05:30 by `src/cross_domain.py`.
...
**Bottom line at the shipped operating point (conf 0.15, imgsz 256).** On steel with no defect in it, 32.5% of strip frames raise an alarm and the detector puts 0.07 boxes on the average tile. Defect recall on the same line is 86.6%, so the alarm carries AUC 0.958 [0.948, 0.968] of information against 0.940 [0.905, 0.970] in domain. The shipped disposition chain returns DOWNGRADE on a clean coil.

### False alarms on genuinely defect-free steel, and recall on the same domain

| conf | clean-crop FA [95% CI] | clean-FRAME FA [95% CI] | boxes/crop | defect crop recall [95% CI] | defect frame recall |
|---|---|---|---|---|---|
| 0.05 | 11.9% [10.5, 13.3] | 52.9% [48.3, 57.4] | 0.17 | 93.0% [90.8, 95.1] | 100.0% |
| 0.10 | 7.8% [6.7, 8.9] | 40.2% [36.0, 44.6] | 0.10 | 89.9% [87.4, 92.3] | 98.4% |
| 0.15 **<- shipped** | 5.9% [5.0, 6.9] | 32.5% [28.5, 36.6] | 0.07 | 86.6% [83.7, 89.4] | 97.4% |
| 0.20 | 4.6% [3.8, 5.5] | 26.3% [22.6, 30.3] | 0.05 | 83.2% [79.9, 86.2] | 96.3% |
| 0.25 | 3.6% [2.9, 4.3] | 21.8% [18.4, 25.5] | 0.04 | 80.0% [76.5, 83.4] | 95.3% |
| 0.30 | 3.1% [2.4, 3.8] | 18.4% [15.0, 21.8] | 0.03 | 75.5% [71.6, 79.2] | 93.2% |
| 0.40 | 2.1% [1.6, 2.7] | 13.1% [10.3, 16.0] | 0.02 | 69.8% [65.5, 74.0] | 90.6% |
| 0.50 | 1.3% [0.8, 1.8] | 7.7% [5.5, 10.1] | 0.01 | 62.1% [57.3, 66.9] | 86.9% |
| 0.60 | 0.7% [0.4, 1.1] | 4.8% [3.0, 6.7] | 0.01 | 50.5% [45.5, 55.4] | 77.5% |
| 0.70 | 0.6% [0.3, 0.9] | 4.0% [2.4, 5.7] | 0.01 | 36.6% [32.2, 41.2] | 63.4% |
| 0.80 | 0.3% [0.1, 0.5] | 2.2% [1.0, 3.6] | 0.00 | 17.2% [13.0, 21.5] | 29.3% |

Design effect on the crop false alarm rate ranges 1.15-1.96: treating 4040 tiles as independent draws would have quoted an interval up to 1.40x too narrow.
...
| severstal_1 | 59 | 21.0% |
| severstal_2 | 21 | 7.5% |
| pitted_surface | 17 | 6.0% |
| patches | 7 | 2.5% |
| scratches | 2 | 0.7% |
| inclusion | 2 | 0.7% |
| rolled-in_scale | 2 | 0.7% |

Total 281 boxes on 4040 tiles of steel that carries no defect at all.

For scale: the 982 tiles cut from defective frames but holding no labelled pixels alarm at 11.4%. They are excluded from both arms, but the similarity of that rate to the verified-clean rate is itself evidence that the detector is not responding to the defects.
...
| population | AUC (max box confidence) | 95% CI | positives | negatives |
|---|---|---|---|---|
| cross-domain (Severstal, defective vs verified clean) | 0.958 | [0.948, 0.968] | 546 | 4040 |
| in-domain (NEU-DET test, defect vs mined clean) | 0.940 | [0.905, 0.970] | 197 | 771 |
...
Size-stratified in-domain AUC: **0.905** (pooled 0.940). Either way the in-domain figure sits far above the cross-domain one, and the gap is not a crop-size artefact.
...
```
coil SEVERSTAL-CLEAN-HOLDOUT-JOINT: 480 frames, defect rate 4.8%, 25 detections, p95 severity 0.0 -> DOWNGRADE
  - Defect rate 4.8% above the accept limit of 2.0%.
  - 4 frame(s) in the high band - not releasable as prime.
```

### Shipped disposition chain on a clean coil -- whole 1600x256 strip frames

```
coil SEVERSTAL-CLEAN-HOLDOUT-JOINT-WHOLEFRAME: 60 frames, defect rate 46.7%, 32 detections, p95 severity 50.6 -> HOLD
  - Defect rate 46.7% exceeds the hold limit of 25.0%.
```
...
![clean false alarm rate vs defect recall](gap1_cross_domain_fa_vs_recall.png)
